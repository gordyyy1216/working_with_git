...
Do the following in the terminal and head to the GUI to resolve the conflict. A conflict happens when the same line is edited in two separate instances.
